...
int main(void)
{
	...
	while(fgetc(mmo2)==' ');//skip all whitespace
	i=0;while(i<5)
	{
		if(fgetc(mmo2)==' ')
		i++;
	...
	i=0;while(i<size_atom_numbers)//getting this data works!!
	{
		...
		fseek(mmo2,pos,SEEK_SET);
		while(fgetc(mmo2)==' ');//skip whitespace
		while(fgetc(mmo2)!=' ');//skip first number
		fgets(strholder,sizeof(strholder),mmo2);
	...
	i=0;while(i<size_atom_numbers)
	{
		...
		while(fgetc(mmo2)!=' ');
		while(fgetc(mmo2)==' ');
		while(fgetc(mmo2)!=' ');//skip 3 whitespaces and 3 datas
		fgets(strholder,sizeof(strholder),mmo2);
	...
	i=0;while(i<size_atom_numbers)
	{
		...
		while(fgetc(mmo2)!=' ');
		while(fgetc(mmo2)==' ');
		while(fgetc(mmo2)!=' ');//skip 2 whitespaces and 2 datas
		fgets(strholder,sizeof(strholder),mmo2);
	...
	while(fgetc(mmo2)!=' ');
	while(fgetc(mmo2)==' ');
	while(fgetc(mmo2)!=' ');//skip the big text
	fgets(strholder,sizeof(strholder),mmo2);
	...
	i=0;while(i<size_atom_numbers2)//number 3
	{
		...
		while(fgetc(mmo2)!=' ');
		while(fgetc(mmo2)==' ');
		while(fgetc(mmo2)!=' ');//skip first 2 numbers
		fgets(strholder,sizeof(strholder),mmo2);
	...
	i=0;while(i<size_atom_numbers2)
	{
		...
		while(fgetc(mmo2)!=' ');
		while(fgetc(mmo2)==' ');
		while(fgetc(mmo2)!=' ');//skip first 5 datas
		fgets(strholder,sizeof(strholder),mmo2);
	...
	i=0;while(i<size_atom_numbers2)
	{
		...
		while(fgetc(mmo2)!=' ');
		while(fgetc(mmo2)==' ');
		while(fgetc(mmo2)!=' ');//skip first 3 datas
		fgets(strholder,sizeof(strholder),mmo2);
	...
	while(fgetc(mmo2)!=' ');
	while(fgetc(mmo2)==' ');
	while(fgetc(mmo2)!=' ');//skip first 5 words
	fgets(strholder,sizeof(strholder),mmo2);
